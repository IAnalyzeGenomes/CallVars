...
rule GATK_HaplotypeCaller:
    ...
    shell:
        "gatk --java-options '{params.mem}' HaplotypeCaller -R {params.REF} -I {input.BAM} --dbsnp {params.dbSNP} -L {params.TARGET} -A StrandBiasBySample -O {output.VCF} --bamout {output.GATK_BAM} &>{log}"
